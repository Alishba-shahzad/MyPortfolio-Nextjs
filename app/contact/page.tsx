  ...
  return (
    <>
      ...
      <section className="bg-white py-6 px-5 sm:px-8 md:px-20 max-w-8xl mx-auto">
        <div className="text-3xl font-extrabold text-center text-gray-900 mb-5">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="flex-nowrap space-y-6 items-center m-10 justify-center text-gray-800">
            <div>
              <a href="mailto:alishbah722@gmail.com">
                <h3 className="text-xl font-semibold text-orange-600 mb-1">Email</h3>
                <p className="hover:underline hover:text-blue-400">📧 alishbah722@gmail.com</p>
              </a>
            </div>
            <div>
          ...
          <form
            className="bg-orange-100 border shadow-md rounded-lg p-6 space-y-4"
            onSubmit={onSubmit}
          >
            <input
              value={name}
